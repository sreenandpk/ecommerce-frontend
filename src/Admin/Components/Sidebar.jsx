...
const Sidebar = () => {
    ...
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 border-end shadow-sm" style={{ width: "260px", minHeight: "100vh", backgroundColor: "#ffffff" }}>
            ...
            <Nav className="nav-pills flex-column mb-auto">
                ...
                {/* SIGN OUT BUTTON - After Back to Website */}
